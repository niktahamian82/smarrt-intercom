...
_0x0:
	...
	.DB  0x69,0x70,0x6F,0x6F,0x72,0x0,0x20,0x45
	.DB  0x6E,0x74,0x65,0x72,0x20,0x50,0x61,0x73
	.DB  0x77,0x6F,0x72,0x64,0x20,0x0,0x20,0x20
	.DB  0x20,0x50,0x61,0x73,0x77,0x6F,0x72,0x64
	.DB  0x20,0x4F,0x4B,0x20,0x20,0x20,0x0,0x20
	.DB  0x50,0x61,0x73,0x77,0x6F,0x72,0x64,0x20
	.DB  0x4E,0x4F,0x54,0x20,0x4F,0x4B,0x20,0x20
	.DB  0x0,0x50,0x72,0x65,0x73,0x73,0x20,0x31
	.DB  0x20,0x74,0x6F,0x20,0x6F,0x70,0x65,0x6E
	.DB  0x0,0x20,0x20,0x74,0x68,0x65,0x20,0x64
	.DB  0x6F,0x6F,0x72,0x21,0x20,0x20,0x0,0x42
	.DB  0x75,0x74,0x74,0x6F,0x6E,0x20,0x31,0x20
	.DB  0x68,0x61,0x73,0x20,0x6E,0x6F,0x74,0x0
	.DB  0x62,0x65,0x65,0x6E,0x20,0x70,0x72,0x65
	.DB  0x73,0x73,0x65,0x64,0x0,0x20,0x20,0x20
	.DB  0x57,0x61,0x72,0x6E,0x69,0x6E,0x67,0x21
	.DB  0x20,0x20,0x20,0x0,0x43,0x68,0x65,0x63
	.DB  0x6B,0x20,0x43,0x6F,0x6E,0x6E,0x65,0x63
	.DB  0x74,0x69,0x6F,0x6E,0x2E,0x2E,0x2E,0x0
	.DB  0x54,0x68,0x65,0x20,0x64,0x6F,0x6F,0x72
	.DB  0x20,0x6F,0x70,0x65,0x6E,0x65,0x64,0x21
	.DB  0x0
_0x2000003:
	.DB  0x80,0xC0
...
;#define LED_Red_ON            PORTA.3=1
;#define LED_Red_OFF           PORTA.3=0
;#define LED_Yellow_ON         PORTA.1=1
;#define LED_Yellow_OFF        PORTA.1=0
;#define LED_White_ON           PORTA.0=1
;#define LED_White_OFF          PORTA.0=0
...
; 0000 00A6 DDRD=(0<<DDD7) | (0<<DDD6) | (1<<DDD5) | (0<<DDD4) | (1<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(40)
	OUT  0x11,R30
; 0000 00A7 // State: Bit7=T Bit6=T Bit5=T Bit4=0 Bit3=T Bit2=T Bit1=T Bit0=T
; 0000 00A8 PORTD=(0<<PORTD7) | (0<<PORTD6) | (0<<PORTD5) | (0<<PORTD4) | (1<<PORTD3) | (0<<PORTD2) | (0<<PORTD1) | (0<<PORTD0);
	LDI  R30,LOW(8)
	OUT  0x12,R30
; 0000 00A9 
...
_0x56:
; 0000 0137 {
; 0000 0138     LED_Yellow_ON;
	SBI  0x1B,1
; 0000 0139     LED_Green_OFF;
	CBI  0x1B,2
; 0000 013A     LED_Red_OFF;
	CBI  0x1B,3
; 0000 013B     LED_White_OFF;
	CBI  0x1B,0
; 0000 013C     while ( Check == 0 )
_0x61:
	LDS  R30,_Check
	LDS  R31,_Check+1
	SBIW R30,0
	...
	RJMP _0x63
; 0000 013D     {
; 0000 013E     key=key_pad();
	RCALL _key_pad
	MOVW R16,R30
; 0000 013F     lcd_gotoxy(0,0);
	RCALL SUBOPT_0x1
; 0000 0140     lcd_puts(" Enter Pasword ");
	__POINTW2MN _0x64,0
	RCALL _lcd_puts
; 0000 0141     if ( key == 12 )
	LDI  R30,LOW(12)
...
_0x68:
	...
	CPC  R31,R7
	BRNE _0x69
; 0000 014F         Temp_Pass_3=key;
	__PUTWMRN _Temp_Pass_3,0,16,17
; 0000 0150         if(xy==4)
_0x69:
	LDI  R30,LOW(4)
	LDI  R31,HIGH(4)
	...
	CPC  R31,R7
	BRNE _0x6A
; 0000 0151         Temp_Pass_4=key;
	__PUTWMRN _Temp_Pass_4,0,16,17
; 0000 0152 
; 0000 0153         Beep(1,100,100);
_0x6A:
	RCALL SUBOPT_0x5
; 0000 0154         delay_ms(550);
	LDI  R26,LOW(550)
	LDI  R27,HIGH(550)
	CALL _delay_ms
; 0000 0155         if(xy>=4)
...
; 0000 0157             xy=0;
	CLR  R6
	CLR  R7
; 0000 0158             if ( Temp_Pass_1==0 &&Temp_Pass_2==0 & Temp_Pass_3==0 && Temp_Pass_4==0 )
	CLR  R0
	CP   R0,R10
	CPC  R0,R11
	BRNE _0x6D
	...
	CALL __EQW12
	MOV  R0,R30
	LDS  R26,_Temp_Pass_3
	LDS  R27,_Temp_Pass_3+1
	LDI  R30,LOW(0)
	LDI  R31,HIGH(0)
	CALL __EQW12
	AND  R30,R0
	BREQ _0x6D
	LDS  R26,_Temp_Pass_4
	LDS  R27,_Temp_Pass_4+1
	SBIW R26,0
	BREQ _0x6E
_0x6D:
	RJMP _0x6C
_0x6E:
; 0000 0159             {
; 0000 015A                 LED_Yellow_OFF;
	CBI  0x1B,1
; 0000 015B                 LED_Light(4);
	RCALL SUBOPT_0x4
; 0000 015C                 lcd_clear();
...
_0x6C:
; 0000 0164             {
; 0000 0165                 LED_Yellow_OFF;
	CBI  0x1B,1
; 0000 0166                 LED_Green_OFF;
	CBI  0x1B,2
; 0000 0167                 LED_Red_ON;
	SBI  0x1B,3
; 0000 0168                 LED_White_OFF;
	CBI  0x1B,0
; 0000 0169                 Relay_OFF;
	CBI  0x12,5
; 0000 016A                 lcd_clear();
...
; 0000 016C                 lcd_puts(" Pasword NOT OK  ");
	__POINTW2MN _0x64,33
	RCALL _lcd_puts
; 0000 016D                 delay_ms(2500);
	LDI  R26,LOW(2500)
	LDI  R27,HIGH(2500)
	CALL _delay_ms
; 0000 016E                 Temp_Pass_1 = 0;
	CLR  R10
	CLR  R11
; 0000 016F                 Temp_Pass_2 = 0;
	CLR  R12
	CLR  R13
; 0000 0170                 Temp_Pass_3 = 0;
	LDI  R30,LOW(0)
	STS  _Temp_Pass_3,R30
	STS  _Temp_Pass_3+1,R30
; 0000 0171                 Temp_Pass_4 = 0;
	STS  _Temp_Pass_4,R30
	STS  _Temp_Pass_4+1,R30
; 0000 0172                 lcd_clear();
_0x97:
	RCALL _lcd_clear
; 0000 0173             }
...
_0x7C:
	...
	BRNE _0x7E
; 0000 0179    {
; 0000 017A         LED_Red_ON;
	SBI  0x1B,3
; 0000 017B         LED_Green_OFF;
	CBI  0x1B,2
; 0000 017C         key=key_pad();
	RCALL _key_pad
	MOVW R16,R30
; 0000 017D         lcd_gotoxy(0,0);
	RCALL SUBOPT_0x1
; 0000 017E         lcd_puts("Press 1 to open");
	__POINTW2MN _0x64,51
	RCALL SUBOPT_0x2
; 0000 017F         lcd_gotoxy(0,1);
; 0000 0180         lcd_puts("  the door!  ");
	__POINTW2MN _0x64,67
	RCALL _lcd_puts
; 0000 0181         if ( key == 1 )
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
...
; 0000 018C             lcd_puts("Button 1 has not");
	__POINTW2MN _0x64,81
	RCALL SUBOPT_0x2
; 0000 018D             lcd_gotoxy(0,1);
; 0000 018E             lcd_puts("been pressed");
	__POINTW2MN _0x64,98
	RCALL _lcd_puts
; 0000 018F             Beep(3,100,100);
	LDI  R30,LOW(3)
	LDI  R31,HIGH(3)
	ST   -Y,R31
	ST   -Y,R30
...
; 0000 0199         lcd_puts("   Warning!   ");
	__POINTW2MN _0x64,111
	RCALL SUBOPT_0x2
; 0000 019A         lcd_gotoxy(0,1);
; 0000 019B         lcd_puts("Check Connection...");
	__POINTW2MN _0x64,126
	RCALL _lcd_puts
; 0000 019C         delay_ms(20000);
	LDI  R26,LOW(20000)
	LDI  R27,HIGH(20000)
	CALL _delay_ms
; 0000 019D         lcd_clear();
...
; 0000 019F         lcd_puts("   Warning!   ");
	__POINTW2MN _0x64,146
	RCALL SUBOPT_0x2
; 0000 01A0         lcd_gotoxy(0,1);
; 0000 01A1         lcd_puts("The door opened!");
	__POINTW2MN _0x64,161
	RCALL _lcd_puts
; 0000 01A2         LED_Red_OFF;
	CBI  0x1B,3
; 0000 01A3         LED_Green_ON;
	SBI  0x1B,2
; 0000 01A4         Relay_ON;
	SBI  0x12,5
; 0000 01A5         LED_Light(4);
	LDI  R26,LOW(4)
	LDI  R27,0
	RCALL _LED_Light
