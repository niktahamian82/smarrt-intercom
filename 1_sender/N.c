...
DDRD=(0<<DDD7) | (0<<DDD6) | (1<<DDD5) | (0<<DDD4) | (1<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
...
while (1)
{
    ...
    else 
    {
        ...
        {
            xy=0;
            if ( Temp_Pass_1==0 &&Temp_Pass_2==0 & Temp_Pass_3==0 && Temp_Pass_4==0 )
            {
                LED_Yellow_OFF;
                LED_Light(4);
                lcd_clear();
